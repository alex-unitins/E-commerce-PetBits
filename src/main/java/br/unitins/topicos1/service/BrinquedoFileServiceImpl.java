...
@ApplicationScoped
public class BrinquedoFileServiceImpl implements FileService {

   // ex. /user/janio/quarkus/images/usuario/
    private final String PATH_USER = System.getProperty("user.home")
        + File.separator + "quarkus"
        + File.separator + "images"
        + File.separator + "brinquedo" + File.separator;
    ...
    public void salvar(Long id, String nomeImagem, byte[] imagem) {
        ...
        try {
            brinquedo.setNomeImagem(salvarImagem(imagem, nomeImagem));
        } catch (IOException e) {
