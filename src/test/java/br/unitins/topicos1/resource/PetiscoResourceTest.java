...
public class PetiscoResourceTest {
    ...
    public void createTest() {
        PetiscoDTO dto = new PetiscoDTO("PetiscoTest", 10.0, "criar",1 ,  1L,1L,"Cachorro",1,21);
    ...
    public void updateTest() {
        PetiscoDTO dto = new PetiscoDTO("PetiscoTest", 10.0, "deletar",2 ,  1L,1L,"gato",1,21);
        given()
            .contentType(MediaType.APPLICATION_JSON)
            .body(dto)
            .when()
    ...
    public void deleteTest() {
        PetiscoResponseDTO response = petiscoService.create(new PetiscoDTO("PetiscoTest", 10.0, "deletar",2 ,  1L,1L,"gato",1,2));
