...
public class RemedioResourceTest {
    ...
    public void createTest() {
        RemedioDTO dto = new RemedioDTO("Anti-pulgas", 25.00, "criar", "1 comprimido", 2L, "cão",2, 1,6);
    ...
    public void updateTest() {
        RemedioDTO dto = new RemedioDTO("Anti-pulgas", 25.00, "atualizar", "1 comprimido", 2L, "cão",2, 1,5);
        given()
            .contentType(MediaType.APPLICATION_JSON)
            .body(dto)
            .when()
    ...
    public void deleteTest() {
        RemedioResponseDTO response = remedioService.create(new RemedioDTO("Anti-pulgas", 25.00, "deletar", "1 comprimido", 2L, "cão",2, 1,7));
