...
public class BrinquedoResourceTest {
    ...
    public void createTest() {
        BrinquedoDTO dto = new BrinquedoDTO("testCriar", 12.2, "criar", "material de teste", Long.valueOf(2), "animalcriar", 2);
    ...
    public void updateTest() {
        BrinquedoDTO dto = new BrinquedoDTO("testAtualizar", 10.2, "atualizar", "material de update", 1l, "animalatualizar", 1);
    ...
    public void deleteTest() {
        BrinquedoResponseDTO response = brinquedoService.create(new BrinquedoDTO("testDeletar", 15.2, "criar pra deletar", "material de deletar", 1L, "animaldeletar", 1));
