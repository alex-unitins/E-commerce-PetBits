...
public class RacaoResourceTest {
    ...
    public void createTest() {
        RacaoDTO dto = new RacaoDTO("Para gatos", 20.75, "criar", 3L,4L, "gato",3, 1,4);
    ...
    public void updateTest() {
        RacaoDTO dto = new RacaoDTO("Para gatos", 20.75, "atualizar", 3L,4L, "gato",3, 1,6);
        given()
            .contentType(MediaType.APPLICATION_JSON)
            .body(dto)
            .when()
    ...
    public void deleteTest() {
        RacaoResponseDTO response = racaoService.create(new RacaoDTO("Para gatos", 20.75, "deletar", 3L,4L, "gato",3, 1,23));
